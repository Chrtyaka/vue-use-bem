...
export type BemGeneratorArgs = Required<Pick<BemPluginOptions, 'hyphenate' | 'delimiters'>>;
export type BemGeneratorFunction = (element: string, mods: BemModifiers) => string;
